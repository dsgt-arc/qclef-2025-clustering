...
def run_pipeline(config):
    ...
    quantum_clustering = QuantumClustering(k_range, medoid_embeddings, config)
    refined_medoid_indices, silhouettes_quantum = quantum_clustering.solve_qubo(doc_embeddings_reduced)
 
    refined_medoid_embeddings = medoid_embeddings[refined_medoid_indices] #Medoid embeddings is on the reduced already,. this should be it.
